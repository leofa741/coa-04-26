      ...
      {isOpen && project && (
        <>
          ...
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="fixed inset-4 md:inset-10 z-50 flex flex-col bg-dark-800 rounded-3xl border border-white/10 overflow-hidden shadow-2xl"
                    ...
                    {images.map((_, i) => (
                      <span
                        ...
                        className={`w-2 h-2 rounded-full transition-all ${
                          i === 0 ? "bg-brand-500 w-4" : "bg-white/30"
                        }`}
                      />
                    ))}
                  </div>
